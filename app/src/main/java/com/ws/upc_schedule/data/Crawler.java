...
//        String term = LoginRepository.getTerm(contexts[0]);
        ...
        if(term == null){
            //获得学期：
            //先设为第二学期，爬取一周开学日期，若等于今天（规律），则爬取上学期课表
            try {
            ...
            term = Parser.getTerm();
            Log.d("data",term);
            LoginRepository.setTerm(contexts[0],term);
        }
        try{
//            Log.d("data","开始获取数据");
//            for(int i=1;i<19;i++){
...
//            Log.d("data",e.toString());
    ...
    protected void onProgressUpdate(Document... documents){
        ...
        Log.d("data","almost start parsing");
